...
const WEATHER_ICON_PATHS = {
  ...
  drizzle: '<path class="cloud-main" d="M17 38h31a9.5 9.5 0 0 0 1-18.9 15 15 0 0 0-28.4 5.2A8 8 0 0 0 17 38Z"/><path class="cloud-soft" d="M16 38h29.5a8 8 0 0 0 0-16 13 13 0 0 0-25-2.8A9.5 9.5 0 0 0 16 38Z"/><path class="icon-rain-drop" d="M24 45v7M34 43v8M44 45v7"/>',
  rain: '<path class="cloud-main" d="M16 36h32a10 10 0 0 0 1.1-19.9 15.8 15.8 0 0 0-30 5.3A8.5 8.5 0 0 0 16 36Z"/><path class="cloud-soft" d="M15 36h30.5a8.4 8.4 0 0 0 0-16.8 13.6 13.6 0 0 0-26-3A10.4 10.4 0 0 0 15 36Z"/><path class="icon-rain-drop" d="M22 43v10M32 41v12M42 43v10"/>',
  storm: '<path class="cloud-main storm-cloud" d="M16 35h32a10 10 0 0 0 1.1-19.9 15.8 15.8 0 0 0-30 5.3A8.5 8.5 0 0 0 16 35Z"/><path class="cloud-soft" d="M15 35h30.5a8.4 8.4 0 0 0 0-16.8 13.6 13.6 0 0 0-26-3A10.4 10.4 0 0 0 15 35Z"/><path class="icon-rain-drop" d="M20 43v8M44 43v8"/><path class="bolt" d="M33 35 25 50h8l-3 10 11-17h-8l4-8Z"/>',
