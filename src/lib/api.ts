...
export async function fetchWeatherData(lat: number, lon: number): Promise<OpenMeteoResponse> {
  ...
  url.searchParams.append(
    'hourly',
    'temperature_2m,apparent_temperature,precipitation_probability,precipitation,weathercode,windspeed_10m,winddirection_10m,relativehumidity_2m,uv_index,visibility,surface_pressure,windgusts_10m,cloudcover,cloud_cover_low,cloud_cover_mid,cloud_cover_high,is_day'
  );
  url.searchParams.append(
    'daily',
